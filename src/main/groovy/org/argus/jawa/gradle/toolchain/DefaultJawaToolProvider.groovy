...
public class DefaultJawaToolProvider implements ToolProvider {
    ...
    private Set<File> resolvedScalaClasspath

    public DefaultJawaToolProvider(File gradleUserHomeDir, File rootProjectDir, CompilerDaemonManager compilerDaemonManager, Set<File> resolvedJawaClasspath) {
        this.gradleUserHomeDir = gradleUserHomeDir
        this.rootProjectDir = rootProjectDir
        this.compilerDaemonManager = compilerDaemonManager
        this.resolvedScalaClasspath = resolvedJawaClasspath
    }
