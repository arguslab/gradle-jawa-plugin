...
//        try {
//            def jawaClasspath = resolveDependency(String.format("com.github.arguslab:jawa-compiler_2.11:%s", targetPlatform.getJawaVersion()))
//            def resolvedJawaClasspath = jawaClasspath.resolve()
